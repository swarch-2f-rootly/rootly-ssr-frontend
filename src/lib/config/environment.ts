...
export const ENV_CONFIG = {
  ...
  PLANTS_SERVICE_URL: process.env.PLANTS_SERVICE_URL || 'http://localhost:8004',
  ANALYTICS_SERVICE_URL: process.env.ANALYTICS_SERVICE_URL || 'http://localhost:8000',
  DATA_MANAGEMENT_SERVICE_URL: process.env.DATA_MANAGEMENT_SERVICE_URL || 'http://localhost:8003',
  ...
  TEST_API_GATEWAY_URL: process.env.TEST_API_GATEWAY_URL || 'http://localhost:8080',
